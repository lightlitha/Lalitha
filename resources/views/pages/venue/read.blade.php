...
@section('content')
  ...
  <hr/>
  <h4 class="text-center">Add New Venue. <i class="fa fa-smile-beam"></i></h4>
  <span class="m-5"></span>
  @if (session('success'))
  ...
  @endif
  <form class="needs-validation" novalidate action="{{ route('venue.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-row">
