...
@section('content')
  ...
  <hr/>
  <h4 class="text-center">Add New Commission. <i class="fa fa-smile-beam"></i></h4>
  <span class="m-5"></span>
  @if (session('success'))
  ...
  @endif
  <form class="needs-validation" novalidate action="{{ route('commissions.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-row">
    ...
    <div class="form-row">
      <div class="col-md-6 mb-3">
        ...
        <input type="number" step='0.01' class="form-control" id="validationName02" name="percentage" value="" required>
        <div class="valid-feedback">
          Looks good!
        </div>
        <div class="invalid-feedback">
